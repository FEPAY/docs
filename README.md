# FEPAY API OpenAPI Specification
[![Build Status](https://travis-ci.com/FEPAY/docs.svg?branch=master)](https://travis-ci.com/FEPAY/docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://fepay.github.io/docs/)
- [SwaggerUI](https://fepay.github.io/docs/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://fepay.github.io/docs/openapi.json) [YAML](https://fepay.github.io/docs/openapi.yaml)
